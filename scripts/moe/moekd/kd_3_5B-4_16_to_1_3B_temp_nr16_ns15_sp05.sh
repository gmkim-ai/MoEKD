...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/moekd/moekd_1_3B/e10-bs4-lr1e-05-G1-N4-NN1-kd0.5-topk${NUM_SELECTS}-nr${NUM_REPEATS}-sp${SAMPLING_PROB}-nns${NEW_NUM_SELECTS}/best_rougeL/log.txt
do
    ${CMD}
    sleep 20
done
