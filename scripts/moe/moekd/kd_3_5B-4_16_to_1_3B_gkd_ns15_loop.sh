...
CKPT="${BASE_PATH}/results/moe/train/sft/sft_1_3B/e10-bs8-lr1e-05-G1-N2-NN1/sft_init"
SAVE_PATH="${BASE_PATH}/results/moe/train/moekd/moekd_1_3B_with_sgo/loop/epoch1"
...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/moekd/moekd_1_3B_with_sgo/loop/epoch1/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5-topk${NUM_SELECTS}/684/pytorch_model.bin
do
    ${CMD}
    sleep 20
done
...
do
    last_epoch=$((epoch - 1))
    CKPT="${BASE_PATH}/results/moe/train/moekd/moekd_1_3B_with_sgo/loop/epoch${last_epoch}/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5-topk${NUM_SELECTS}/684"
    ...
    echo "PYTHONPATH=${PYTHONPATH}"
    mkdir -p ${SAVE_PATH}
    while ! test -f ./results/moe/train/moekd/moekd_1_3B_with_sgo/loop/epoch${epoch}/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5-topk${NUM_SELECTS}/684/pytorch_model.bin
    do
        ${CMD}
        sleep 20
    done
