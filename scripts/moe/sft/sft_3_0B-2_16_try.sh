...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/moe/train/sft/sft_3_0B-2_16"
# seed
SEED=10
SEED_ORDER=10
...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/sft/sft_3_0B-2_16/e10-bs4-lr1e-05-G1-N4-NN1/6840/pytorch_model.bin
do
    ${CMD}
    sleep 20
done
