...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/moe/train/kd/kd_1_3B/sft_3_0B-2_16"
# seed
SEED=10
...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/kd/kd_1_3B/sft_3_0B-2_16/e10-bs4-lr1e-05-G1-N4-NN1-kd0.5/6840/pytorch_model.bin
do
    ${CMD}
    sleep 20
done

bash scripts/moe/eval/run_eval.sh . results/moe/train/kd/kd_1_3B/sft_3_0B-2_16/e10-bs4-lr1e-05-G1-N4-NN1-kd0.5/best_rougeL 15035 llama ${GPUS_PER_NODE}