...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/gkd/kd_2_7B_to_1_3B/loop/epoch1/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5/684/pytorch_model.bin
do
    ${CMD}
    sleep 20
done
...
do
    last_epoch=$((epoch - 1))
    CKPT="${BASE_PATH}/results/moe/train/gkd/kd_2_7B_to_1_3B/loop/epoch${last_epoch}/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5/684"
    ...
    echo "PYTHONPATH=${PYTHONPATH}"
    mkdir -p ${SAVE_PATH}
    while ! test -f ./results/moe/train/gkd/kd_2_7B_to_1_3B/loop/epoch${epoch}/e1-bs4-lr1e-05-G1-N4-NN1-kd0.5/684/pytorch_model.bin
    do
        ${CMD}
        sleep 20
    done
