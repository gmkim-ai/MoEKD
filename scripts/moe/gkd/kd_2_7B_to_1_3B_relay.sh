...
mkdir -p ${SAVE_PATH}
while ! test -f ./results/moe/train/gkd/kd_2_7B_to_1_3B/e9-bs4-lr5e-06-G1-N4-NN1-kd0.5/best_rougeL/log.txt
do
    ${CMD}
    sleep 20
done

#bash scripts/moe/eval/run_eval.sh . results/moe/train/gkd/kd_2_7B_to_1_3B/e9-bs4-lr5e-06-G1-N4-NN1-kd0.5/best_rougeL 15035 llama ${GPUS_PER_NODE}